...
// Getters------------------------------------------------------------
const size_t& DynamicArray::getLength() const { return m_length; }

const size_t& DynamicArray::getCapacity() const { return m_capacity; }

const double& DynamicArray::getScalingFactor() const { return m_scaling_factor; }

// Setters-----------------------------------------------------------
void DynamicArray::setScalingFactor(double value) { m_scaling_factor = value; }
